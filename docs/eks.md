...
Region `eu-central-1` (Frankfurt) was chosen to meet geographical proximity to the company's operations in Germany as well as potential regulatory requirements (e.g. GDPR).
